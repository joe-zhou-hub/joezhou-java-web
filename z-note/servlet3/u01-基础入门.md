...
- psm: `{{tomcat}}/servlet3/api/annotation-a`
- psm: `{{tomcat}}/servlet3/api/annotation-b`
...
- psm: `{{tomcat}}/servlet3/api/servlet-config-xml`
- psm: `{{tomcat}}/servlet3/api/servlet-config-annotation`
...
- psm: `{{tomcat}}/servlet3/api/servlet-context`
...
- psm: `{{tomcat}}/servlet3/api/life-cycle`