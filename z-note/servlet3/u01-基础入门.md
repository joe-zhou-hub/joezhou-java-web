...
**源码：** /servlet3/
- src: `com.joezhou.start.servlet.XmlServlet.java`
- res: `web.xml`
...
**源码：** /servlet3/
- src: `start.servlet.AnnotationServlet.java`
- psm: `{{tomcat}}/servlet3/api/servlet/annotation_a`
- psm: `{{tomcat}}/servlet3/api/servlet/annotation_b`
...
**源码：** /servlet3/
- src: `com.joezhou.start.servlet.ServletConfigXmlServlet.java`
- res: `web.xml`
- src: `com.joezhou.start.servlet.ServletConfigAnnotationServlet.java`
