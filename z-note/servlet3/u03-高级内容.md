...
- `ServletRequestAttributeListener`：监听 `HttpServletRequest` 域中的属性：
    - `attributeAdded()`：属性被添加时触发。
    - `attributeRemoved()`：属性被移除时触发。
    - `attributeReplaced()`：属性被修改时触发。
...
**源码：** /servlet3/
- src: `c.j.listener.RequestListener`
- src: `c.j.listener.RequestListenerServlet`
- src: `c.j.listener.RequestAttributeListener`
- src: `c.j.listener.RequestAttributeListenerServlet`
- psm: `{{tomcat}}/servlet3/api/request-listener`
- psm: `{{tomcat}}/servlet3/api/request-attribute-listener`
